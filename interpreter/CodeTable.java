...
public class CodeTable {
  ...
  public static void init () {
      ...
      byteCodeMap.put( "LINE", (new LineCode()).getClassName() );
      byteCodeMap.put( "FUNCTION", (new FunctionCode()).getClassName() );
      byteCodeMap.put( "FORMAL", (new FormalCode()).getClassName() );
