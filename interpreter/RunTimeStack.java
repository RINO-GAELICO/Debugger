...
public class RunTimeStack {
  ...
  public int pop() {
    ...
    if(pointerTopStack>(-1) && pointerTopStack>=framePointers.peek()){
      ...
      pointerTopStack--;
      offsetTracker = pointerTopStack - framePointers.peek();
      return poppedValue;
    }else{
  ...
  public int getOffsetValue(int offsetPosition){
    
    return runStack.get(offsetPosition + framePointers.peek());
  }

  public void setOffsetTracker(int newOffset){
    offsetTracker = newOffset;
